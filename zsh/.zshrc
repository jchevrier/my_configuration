...
POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%K{240}%F{white} \UE12E %D{%H:%M:%S}  %f%k%F{240}\UE0B0%f '
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%K{240}%F{white} \UE12E %D{%H:%M:%S}  %f%k%F{240}\UE0B0%f '
